...
mkdir("theurls/".$short);
$myfile = fopen("theurls/".$short."/index.php", "w") or die("failed");
$txt = '<?php
...
input{
  ...
  border-radius: 4px;
  resize: vertical;
}</style><h1 style="text-align:center;"><input type="text" value="https://'.$_SERVER['HTTP_HOST']."/theurls/".$short.'" id="myInput">
