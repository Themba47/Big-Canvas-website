<header>
		<div class="container">
			<div id="header">
				<div id="logo">
					<a id="brand" href="index.php"><img src="img/thebc2.png" width="40"></a>
				</div>
				<div id="title">
					<h1>Big Canvas</h1>
					<div id="demo"></div>
						...
						<li class="nav-item" id="navigation">
							...
							<?php 
								if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
									echo "<a class='links' href='login.php'>Log In</a>"; 
							}else {
