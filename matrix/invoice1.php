...
<script>
  ...
  gtag('config', 'UA-108740911-1');
    ...
    <title>Click here to get started on creating your newsletter | Johannesburg South Africa</title>
  ...
  <div id="die-kop"><?php include('headsgubu.php'); ?></div>
    ...
    <div class="container" id="main" style="background-color: rgb(255, 255, 255);padding: 5% 0; border-radius: 15px; max-width: 600px;margin: auto;">
          <div id="newsletter" style="background-color: aliceblue;margin: 5%;">
            ...
            <div class="body" style="padding: 5%;">
                <div id="msg">
                  <div id="dateorder" style="display: grid; grid-template-columns: 1fr 1fr;">
                    <p contenteditable="true" class="txt-color">Order number: 029358430</p>
                    <p contenteditable="true" class="txt-color">Estimated delivery date: 2022-05-03</p>
                  </div>
                  <p contenteditable="true" class="txt-color">Hi name:<br><br>
                  Your order has been placed</p><br>
                </div>
                <table class="thetable" style="border-collapse: collapse;
					width: 80%;
                    ...
                    <tr>
                        <td contenteditable="true">The invoice</td>
                  ...
                  <div id="total" style="width: 100%;
							display: grid;
							text-align: right;">
                    <p contenteditable="true" class="txt-color">SubTotal: R 100.00</p>
                    <p contenteditable="true" class="txt-color">Shipping fee: R 340.00</p>
                        
                        <p contenteditable="true" class="txt-color">Total: R 230.00</p>
                  </div><br>
      ...
      <div class="btn-div"><a href="javascript:void(0)" class="btn-anchor" onclick="changeColor(4)" title="image"><i class="fa fa-fill-drip bttn"></i><p class="text-tab">Table</p></a></div>
      ...
      <div class="btn-div"><a href="javascript:void(0)" class="btn-anchor" onclick="AddColumn()" title="Add column"><i class="fas fa-edit bttn"></i><p class="text-tab">Add Column</p></a></div>
      <div id="myinputs"></div>
    ...
    <script>
      ...
      document.querySelector(".thetable tr:nth-child(odd)").style.cssText = "background-color: rgba(255, 255, 255, 0.82);color:rgb(0, 0, 0);"
      document.querySelector(".thetable tr:nth-child(1)").style.cssText = "background-color: rgba(24, 145, 241); color: #000;"
      ...
      bttn[3].style.backgroundColor = "rgba(24, 145, 241)";
      bttn[4].style.backgroundColor = "rgba(191, 56, 56)";
  ...
  if (
    ...
    txt_area.style.display = "none";
      ...
      async function createForm(theBlob) {
        ...
        .then(data => {
            mylogo.src = "https://www.bigcanvas.co.za/images/" + newfilename;
...
pickr.on('change', (...args) => {
  ...
  switch (mow) {
      ...
      case 5:
        ...
        bttn[4].style.backgroundColor = color;
          break;
      default:
          break;
  }
