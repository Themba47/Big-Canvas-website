...
<script>
  ...
  <?php include('headsgubu.php'); ?>
    ...
    <div class="container main">
      ...
      <a href="javascript:void(0)" onclick="changeGradient()" title="gradient" class="bttn"><i class="fas fa-paint-roller" style="font-size:25px; color: #ffffff;"></i></a>
      <a href="javascript:void(0)" onclick="changeO()" title="orientation" class="bttn"><i class="fas fa-redo" style="font-size:25px; color: #ffffff;"></i></a>
      <div id="myinputs"></div>
    ...
    <script>
      ...
      font_num = 0,
      gradients = [{c1: "red", c2: "blue"}, {c1: "green", c2: "yellow"}, {c1: "purple", c2: "cyan"}],
      gradient_num = 0,
  ...
  if (
    ...
    txt_area.style.display = "none";
      ...
      function changeGradient() {
        if(gradient_num >= gradients.length -1) {
                    gradient_num = 0;
                } else {
                    gradient_num++;
                }
                bcl.style.backgroundImage = "linear-gradient("+gradients[gradient_num].c1+","+gradients[gradient_num].c2+")";
      }
     ...
     function changeIMG() {
      ...
      inputFile.onchange = () => {
        ...
        reader.onloadend = () => {
          bcl.style.backgroundImage = "url("+reader.result+")";
          document.getElementById("blackscreen").style.backgroundColor = "#0000002b";
        }
        if (myfile) {
