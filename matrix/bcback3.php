...
<script>
  ...
  <?php include('headsgubu.php'); ?>
    ...
    <div class="container main">
      ...
      <a href="javascript:void(0)" onclick="changeIMG()" title="font"  class="bttn"><i class="far fa-id-card" style="font-size:25px; color: #ffffff;"></i></a>
      <a href="javascript:void(0)" onclick="changeBackImg()" title="image" class="bttn"><i class="fa fa-image" style="font-size:25px; color: #ffffff;"></i></a>
      <a href="javascript:void(0)" onclick="changeO()" title="angle" class="bttn"><i class="fas fa-redo" style="font-size:25px; color: #ffffff;"></i></a>
      <div id="myinputs"></div>
